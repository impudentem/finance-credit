      ...
      module = {
        ...
        determine: {
          ...
          eventPos: function(event, originalEvent) {
            if(module.is.touch()) {
              var
                changedTouches = event.changedTouches || event.originalEvent.changedTouches,
                touches = event.touches || event.originalEvent.touches
              ;
              var
                touchY = changedTouches[0].pageY || touches[0].pageY,
                touchX = changedTouches[0].pageX || touches[0].pageX
              ;
              return module.is.vertical() ? touchY : touchX;
            }
            var
              clickY = event.pageY || event.originalEvent.pageY || originalEvent.pageY,
              clickX = event.pageX || event.originalEvent.pageX || originalEvent.pageX
            ;
        ...
        set: {
          value: function(newValue, meta) {
            module.update.value(newValue, function(value) {
              settings.onChange.call(element, value, meta);
            });
          },
...
;(function(factory) {
    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                slideTrack: '<div class="slick-track"/>',
                autoplay: false,
                autoplaySpeed: 3000,
                centerMode: false,
                centerPadding: '50px',
    ...
    Slick.prototype.buildOut = function() {
        ...
        _.$slideTrack = (_.slideCount === 0) ?
            $(_.options.slideTrack).appendTo(_.$slider) :
            _.$slides.wrapAll(_.options.slideTrack).parent();
